...
class BenchArgs:
    ...
    enable_profile_prefill_rpd: bool = False
    enable_profile_decode_rpd:  bool = False
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            "--enable-profile-prefill-rpd",
            action='store_true',
            help="enable prefill profiler using rpd.")
        parser.add_argument(
            "--enable-profile-decode-rpd",
            action='store_true',
            help="enable decode profiler using rpd.")
...
def latency_test_run_once(
    ...
    profile_stage,
    tp_rank,
    enable_profile_prefill_rpd=None,
    enable_profile_decode_rpd=None,
):
    ...
    if enable_profile_prefill_rpd and tp_rank == 0:
        print("Start RPD profile Prefill")
...
def latency_test(
    ...
    for bs, il, ol in itertools.product(
        ...
        ret = latency_test_run_once(
            ...
            tp_rank,
            bench_args.enable_profile_prefill_rpd,
            bench_args.enable_profile_decode_rpd,
        )
        if ret is not None:
