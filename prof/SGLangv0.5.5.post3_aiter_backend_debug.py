    ...
    def forward_decode(
        ...
        if self.use_mla:
            ...
            if layer.layer_id == 0 and self.tp_rank == 0:
                print(f"[DEBUG] n_token={n_token}")
            DUMP = os.getenv('SGLANG_DUMP', False)
            if DUMP and layer.layer_id == 0 and n_token in [257, 2048, 2300]:
                if self.tp_rank==0:
                ...
                input_data = {
                    "version": version,
                    "o": o.clone().detach(),
                    "workspace_buffer_shape": self.workspace_buffer.shape,
                ...
                folder = "/home/jacchang/PR/aiter/prof/1127/data/"
                ...
                try:
                    ...
                    print(f"--- Data saving success: {os.path.abspath(output_filename)} ---")
